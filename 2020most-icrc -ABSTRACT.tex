...
% B. 理論值計算及分析
基於前兩年的計畫成果，我們可以得到網路的效能方程式，接下來會去尋找有效率的最佳化演算法讓整體網路的表現提升到最佳狀態。並且分析相關的演算法，結合其優點，設計出適用於這個網路環境的演算法，透過代入數據以驗證其效能，實現先前提到的在變化快速的無線環境下以最快的速度找出最佳$T_{cs}$以獲得��佳網路效能(network capacity)的目的。
